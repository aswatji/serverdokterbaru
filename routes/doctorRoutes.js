...
router.post('/schedules', authMiddleware, requireDoctor, addScheduleValidation, validateRequest, doctorController.addSchedule);
...
router.put('/schedules/:scheduleId', authMiddleware, updateScheduleValidation, validateRequest, doctorController.updateSchedule);

// 10. DELETE /doctor/schedules/:scheduleId → doctorController.deleteSchedule
router.delete('/schedules/:scheduleId', authMiddleware, doctorController.deleteSchedule);
