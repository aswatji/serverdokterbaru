...
router.post('/', createConsultationValidation, validateRequest, consultationController.createConsultation);
router.put('/:id', updateConsultationValidation, validateRequest, consultationController.updateConsultation);
